...
{
  "status": "success",
  "message": "Registration successful. A 6-digit OTP has been sent to your phone number. Please verify to activate your account.",
  "data": {
    "user_id": 1,
    "username": "john_doe"
  },
...
Send or resend a 6-digit OTP to a user's registered phone number.
...
- `code` (required): 6-digit OTP code from password reset
